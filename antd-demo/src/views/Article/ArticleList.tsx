...
class ArticleList extends Component<ArticleProps, Partial<ArticleState>>{
        ...
        return (
            <div className="site-card-border-less-wrapper">
                <Card
                    ...
                    title="Article List"
                    bordered={false} >
                    <Table dataSource={this.state.dataSource} columns={this.state.columns} rowKey='id' pagination={{total: this.state.total, onChange: this.onPageChange, showSizeChanger: true, showQuickJumper: true, onShowSizeChange: this.onShowSizeChange}} loading={this.state.isLoading}/>;
                </Card>
            </div>
        );
    }
